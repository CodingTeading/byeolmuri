...
별 15,527개 **전부** 매칭됐습니다. 알려진 값과 대조해 확인했습니다.

```
        우리 데이터(mas/yr)      알려진 값
시리우스   -546.0, -1223.1      -546.0, -1223.1
아크투루스 -1093.5, -1999.4    -1093.4, -2000.1
베가        201.0,   287.5       200.9,   286.2
북극성       44.2,   -11.7        44.5,   -11.8
```

10만 년을 돌리면 북두칠성 일곱 별이 각각 2.4°~4.0° 움직이고 방향이 서로 달라
국자가 벌어집니다.

**업스트림 데이터 오류**: 세타 큰곰자리(HIP 46853)에 `* eta UMa` 가 잘못
붙어 있습니다. 알카이드는 HIP 67301 입니다. 이름으로 찾을 때 주의하세요.
